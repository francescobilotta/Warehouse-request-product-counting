    ...
    t.uiBackCompat !== !1 &&
        ...
        (t.ui.focusable = function (i, s) {
            ...
            return "area" === l
                ? ((n = i.parentNode),
                  (o = n.name),
                  i.href && o && "map" === n.nodeName.toLowerCase() ? ((a = t("images[usemap='#" + o + "']")), a.length > 0 && a.is(":visible")) : !1)
                ...
                ("button" === s || "both" === s) &&
                    ...
                    (i.trigger = t(
                        this._get(i, "buttonImageOnly")
                            ? t("<images/>").addClass(this._triggerClass).attr({src: o, alt: n, title: n})
                            : t("<button type='button'></button>")
                                  .addClass(this._triggerClass)
                                  .html(o ? t("<images/>").attr({src: o, alt: n, title: n}) : n)
                    )),
