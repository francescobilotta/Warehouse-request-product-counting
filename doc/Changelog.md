...
_Warehouse update operator_<br/>
...
_Getting ready to create the API_<br/>
...
_First use of API from client_<br/>
...
_Added search input_<br/>
![Added search input](changelog_images/14_1.PNG)<br/>
_CHECKPOINT: Fixed Bugs + Added Product Locations_<br/>
